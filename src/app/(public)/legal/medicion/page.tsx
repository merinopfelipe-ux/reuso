...
const T = {
  ES: {
    ...
    s5p1: 'El respeto por la materia prima y su ciclo natural es la esencia artesanal que nos define. Cada material que reutilizas, cada madera que tocas, sientes y disfrutas en lugar de desechar, evita procesos industriales innecesarios. Al certificar este impacto, te entregamos un lenguaje común y estructurado para comunicar tu compromiso real con el planeta.',
    s6Title: 'Limitaciones de la estimación',
    s6Intro: 'Para garantizar la máxima transparencia y evitar el greenwashing, aclaramos lo que este cálculo no incluye.',
    s6Items: [
      ...
      'Los certificados generados son una herramienta de comunicación y educación ambiental de Grupo MLP S.A.S. No equivalen a créditos de carbono transables emitidos por organismos internacionales.',
    ...
    transparenciaIA: 'Desarrollamos esta Calculadora con asistencia de modelos de inteligencia artificial para la estructuración del código. Trabajamos de forma continua auditando las fórmulas para garantizar la precisión técnica de la herramienta.',
  },
  ENG: {
    ...
    s2p2: 'The calculation takes the category and weight (kg) of your project’s main material as input. The system then cross-references this information with our matrix of emission factors and water requirements to estimate the avoided CO₂ eq and liters of water. These internal factors are locked in at the moment of calculation, guaranteeing that historical certificates remain always consistent and verifiable within our platform.',
    ...
    s6Items: [
      ...
      'The certificates generated are an environmental communication and education tool from Grupo MLP S.A.S. They are not equivalent to tradable carbon credits issued by international bodies.',
