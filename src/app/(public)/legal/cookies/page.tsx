...
const T = {
  ES: {
    ...
    s2Rows: [
      ...
      { nombre: '__Host-* / __Secure-*', dominio: 'calculadoradereuso.com (y dominios redirigidos)', duracion: 'Sesión', finalidad: 'Protección CSRF. Previene ataques de falsificación de solicitudes.' },
      { nombre: '_cfuvid, cf_clearance', dominio: 'calculadoradereuso.com (y dominios redirigidos)', duracion: 'Sesión / 24 h', finalidad: 'Cookies de seguridad. Protegen contra bots y ataques de denegación de servicio.' },
    ],
    ...
    s4Rows: [
      { nombre: '_ga, _gid (Analítica web)', dominio: 'calculadoradereuso.com (y dominios redirigidos)', duracion: '2 años / 24 h', finalidad: 'Estadísticas de uso: páginas vistas, tiempo de sesión.' },
      { nombre: '_clck, _clsk (Mapas de calor)', dominio: 'calculadoradereuso.com (y dominios redirigidos)', duracion: '1 año / Sesión', finalidad: 'Mapas de calor y grabación de sesión para analizar el comportamiento del usuario (Microsoft Clarity).' },
    ],
  ...
  ENG: {
    ...
    trust: {
      ...
      cards: [
        ...
        { icon: 'SlidersHorizontal' as const, title: 'You decide', desc: 'You can change your choice at any time from the cookie preferences panel.' },
      ],
    },
    ...
    s2Rows: [
      ...
      { nombre: '__Host-* / __Secure-*', dominio: 'calculadoradereuso.com (and redirecting domains)', duracion: 'Session', finalidad: 'CSRF protection. Prevents cross-site request forgery attacks.' },
      { nombre: '_cfuvid, cf_clearance', dominio: 'calculadoradereuso.com (and redirecting domains)', duracion: 'Session / 24 h', finalidad: 'Security cookies. Protect against bots and denial of service attacks.' },
    ],
    ...
    s4Rows: [
      { nombre: '_ga, _gid (Web Analytics)', dominio: 'calculadoradereuso.com (and redirecting domains)', duracion: '2 years / 24 h', finalidad: 'Usage statistics: page views, session time.' },
      { nombre: '_clck, _clsk (Heatmaps)', dominio: 'calculadoradereuso.com (and redirecting domains)', duracion: '1 year / Session', finalidad: 'Heatmaps and session recording for user behavior analysis (Microsoft Clarity).' },
    ],
