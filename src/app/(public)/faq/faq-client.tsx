...
// en modo noche, solo la opacidad de sus fondos tenues).
const CLUSTER_CONFIG: Record<string, ClusterTheme> = {
  'economia-circular': {
    ...
    dark: {
      primary: 'var(--color-success)',
      primaryText: 'var(--color-success)',
      pillBg: 'rgba(56, 185, 142, 0.15)',
      pillBgHover: 'rgba(56, 185, 142, 0.25)',
      pillText: 'var(--color-success)',
      badgeBg: 'rgba(56, 185, 142, 0.18)',
      badgeText: 'var(--color-success)',
      cardOpenBorder: 'rgba(56, 185, 142, 0.45)',
      cardOpenBg: 'var(--bg-card)',
      cardHoverBorder: 'rgba(56, 185, 142, 0.35)',
      btnBg: 'var(--color-success)',
      btnText: '#FFFFFF',
      dotBg: 'var(--color-success)',
      glowShadow: '0 8px 24px -6px rgba(56, 185, 142, 0.25)',
    },
  },
  'huella-de-carbono': {
  ...
  'certificaciones': {
    ...
    dark: {
      primary: 'var(--color-violeta)',
      primaryText: 'var(--color-violeta)',
      pillBg: 'rgba(152, 95, 161, 0.15)',
      pillBgHover: 'rgba(152, 95, 161, 0.25)',
      pillText: 'var(--color-violeta)',
      badgeBg: 'rgba(152, 95, 161, 0.18)',
      badgeText: 'var(--color-violeta)',
      cardOpenBorder: 'rgba(152, 95, 161, 0.45)',
      cardOpenBg: 'var(--bg-card)',
      cardHoverBorder: 'rgba(152, 95, 161, 0.35)',
      btnBg: 'var(--color-violeta)',
      btnText: '#FFFFFF',
      dotBg: 'var(--color-violeta)',
      glowShadow: '0 8px 24px -6px rgba(152, 95, 161, 0.25)',
    },
  },
}
