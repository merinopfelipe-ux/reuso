...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'medir impacto ambiental empresarial',
    'impacto ambiental empresas',
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Software de Sostenibilidad, Impacto Ambiental y Trazabilidad de Economía Circular' }],
  },
  twitter: {
...
function construirSchemas(planes: PlanPrecioReal[], whatsappNumero: string | undefined) {
  ...
  return [
  {
    ...
    name: 'Reúso',
    legalName: 'Grupo MLP',
    description: 'Calculadora de Reúso es una plataforma de sostenibilidad que ayuda a empresas de restauración, diseño interior y producto a medir el impacto ambiental de reutilizar materiales y objetos, con informes estructurados y códigos de verificación pública.',
    url: 'https://calculadoradereuso.com',
  ...
  },
  {
    ...
    inLanguage: 'es-CO',
    offers: [
      { '@type': 'Offer', name: 'Explora', price: '0', priceCurrency: 'USD', description: '5 cálculos gratis al mes para medir tu impacto ambiental.' },
      ...
      { '@type': 'Offer', name: 'Impacto Ilimitado', price: precioOffer('ilimitado', '87'), priceCurrency: 'USD', description: 'Gestión total de sostenibilidad corporativa, sin límites.' },
    ],
  },
  {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: 'Cómo implementar y medir tu estrategia de sostenibilidad con la Calculadora de Reúso',
    description: 'Guía para gestionar proyectos de sostenibilidad, medir tu impacto ambiental y generar reportes documentados.',
    step: [
      { '@type': 'HowToStep', position: 1, name: 'Digitaliza tus proyectos de economía circular', text: 'Ingresa los datos de tus materiales recuperados en el software de sostenibilidad.' },
      { '@type': 'HowToStep', position: 2, name: 'Mide tu impacto ambiental', text: 'Obtén proyecciones documentadas del impacto ambiental (mitigación estimada de CO₂, huella hídrica y desvío de residuos).' },
      { '@type': 'HowToStep', position: 3, name: 'Reporta y respalda tu impacto', text: 'Genera el Pasaporte Digital de Producto y reportes para facilitar la trazabilidad y documentar tus prácticas de sostenibilidad y Responsabilidad Social.' },
    ],
  },
  {
    '@context': 'https://schema.org',
