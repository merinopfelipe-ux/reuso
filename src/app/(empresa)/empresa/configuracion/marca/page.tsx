...
import { Camera, Save as FloppyDisk, CheckCircle, AlertCircle as WarningCircle, SquareCheck as CheckSquare, Square, Eye, Building2 as Buildings } from '@/components/ui/icons'
      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            {error && (
              <p className="text-sm text-[#FF5E4B] flex items-center gap-1 mb-2">
            ...
            <Button
              onClick={guardar}
              loading={guardando}
              className={`w-full py-3.5 ${guardando ? '' : 'hover-download'}`}
              icon={guardado ? <CheckCircle size={16} /> : <FloppyDisk size={16} strokeWidth={2.5} />}
            >
              {guardado ? 'Marca guardada' : guardando ? 'Guardando...' : 'Guarda tu marca'}
            </Button>
          </div>
