      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className={`rounded-[12px] border p-4 mb-4 ${cardBg}`}>
          ...
          <div className="space-y-2">
            ...
            {cot.fecha_enviada && (
              <TimelineItem
                icon={<PaperPlaneTilt size={14} className="text-[#59A6E4]" />}
            ...
            {cot.fecha_apertura_cliente && (
              <TimelineItem
                icon={<CheckCircle size={14} className="text-[#38B98E]" />}
            ...
            {cot.estado === 'esperando_anticipo' && (
              <TimelineItem
                icon={<CheckCircle size={14} className="text-[#D6F391]" />}
        ...
        <div className={`rounded-[12px] border p-4 mb-4 ${cardBg}`}>
          ...
          <div className={`flex gap-4 mt-2 pt-2 border-t ${isDark ? 'border-white/10' : 'border-[#00827C]/10'}`}>
            <span className={`text-xs flex items-center gap-1 ${ts}`}>
              <Leaf size={12} className="text-[#38B98E]" />
              {co2.toFixed(1)} kg CO2 evitado
            </span>
            <span className={`text-xs flex items-center gap-1 ${ts}`}>
              <Drop size={12} className="text-[#59A6E4]" />
