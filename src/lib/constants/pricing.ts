...
export const PLANS = [
  {
    ...
    priceMonthlyCOP: 0,
    features: [
      'Calculadora de huella de carbono y agua',
      '5 cálculos ambientales al mes',
  ...
  },
  {
    ...
    features: [
      '5 Pasaportes Digitales (DPP) al mes con QR público',
      '5 Informes de impacto con código QR de verificación',
      '5 cálculos de impacto en cada DPP e informe',
      'Tu logo corporativo en informes y pasaportes',
  ...
  },
  {
    ...
    features: [
      ...
      '200 Pasaportes Digitales (DPP) al mes con QR público',
      '8 cálculos de impacto (incluye ROI, costo de propiedad y ciclos)',
      'Asistente de IA: sube fotos o fichas y extrae datos',
      'Cotizador con CRM de clientes y embudo comercial',
      'Categorías y materiales propios personalizados',
      '5 Informes ejecutivos al mes con sello digital',
      'Puesta en marcha guiada, gratis',
      'Soporte por email',
    ],
    limits: {
